...
class ForecastVersionOut(BaseModel):
    id: uuid.UUID
...
class ForecastDraftCreate(BaseModel):
...
class ForecastPromoteResponse(BaseModel):
    version: ForecastVersionOut
