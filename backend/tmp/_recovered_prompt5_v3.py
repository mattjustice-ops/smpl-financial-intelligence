...
CHARTS — REQUIRED (use pptx.addChart; pptx.ChartType on INSTANCE not pptxgen)
Slide 2: KPI sparklines (line) — data from monthly_trends (ending_arr_m, revenue_m, cash_m)
Slide 3: ARR waterfall bar chart — arr_analysis components Actual vs Budget
Slide 6: GTM channel efficiency bar chart — gtm_performance.channels sorted by efficiency
Slide 9: FY ARR trend line — monthly_trends ending_arr_m + h2_arr_forecast_m vs budget
...
Slide 1 — TITLE: Full-bleed centered. No tables.
...
Slide 3 — ARR ANALYSIS: Left 52% waterfall bar chart. Right 48% stacked KPIs
(Net New, G$R, Pipeline Coverage) + compact arr_analysis bridge table + Key Takeaways (max 4 bullets).
