...
| 6 | Confirm [01_system_boundary.md](./soc2/01_system_boundary.md) + [02_subprocessors.md](./soc2/02_subprocessors.md) match production | Engineering owner | **Pack updated 2026-07-28** (prod hosts + Neon us-east-1 evidence); Matt **Q1–Q10** still open → **Week 2–3** |
