...
| Post-LLM citation verify | **Implemented on primary paths** | **Strict** on Prompt 2 (hard-block when fully wiped); Prompt 5 soft-strip + export; **interactive soft-warn** on commentary generate / board regenerate / Copilot — [ai_claim_verify.md](./ai_claim_verify.md) |
