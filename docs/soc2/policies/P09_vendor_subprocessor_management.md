...
5. For AI vendors: confirm keys stay on API only; prompt data categories documented ([P06](./P06_data_classification_and_handling.md)); follow [P15](./P15_ai_llm_data_handling.md) (**Approved** 2026-07-28).
