...
| R16 | Unsigned / incomplete Customer DPA–MSA (privacy, retention, subprocessors) | 2 | 3 | 6 | **Single legal workstream** — counsel + Matt; track in [../PROGRESS.md](../PROGRESS.md) + this row. **Sent to counsel 2026-07-29** — awaiting redline / customer-ready draft; R16 **open / in progress** (not closed). Firm: **[MATT FILL]** / unspecified. Matt attested send via chat (agent did not email) — [../evidence/dpa-counsel-sent-2026-07-29.md](../evidence/dpa-counsel-sent-2026-07-29.md); chase pack [../DPA_COUNSEL_CHASE_PACK.md](../DPA_COUNSEL_CHASE_PACK.md); send package [../legal/COUNSEL_SEND_PACKAGE.md](../legal/COUNSEL_SEND_PACKAGE.md). P07/P08/P09 cross-reference here; do not treat as three separate policy gaps. | Medium until signed | Matt | Mitigate (open — sent to counsel; not closed) |
