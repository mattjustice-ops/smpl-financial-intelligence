...
| R16 | Unsigned / incomplete Customer DPA–MSA (privacy, retention, subprocessors) | 2 | 3 | 6 | **Single legal workstream** — counsel + Matt; track in [../PROGRESS.md](../PROGRESS.md) + this row. **Counsel send package ready 2026-07-29** ([../legal/COUNSEL_SEND_PACKAGE.md](../legal/COUNSEL_SEND_PACKAGE.md); [../legal/DRAFT_EMAIL_TO_COUNSEL.md](../legal/DRAFT_EMAIL_TO_COUNSEL.md); outline) — awaiting **Matt send**; email not sent by agent; **not closed**. P07/P08/P09 cross-reference here; do not treat as three separate policy gaps. | Medium until signed | Matt | Mitigate (open — package ready, not sent) |
