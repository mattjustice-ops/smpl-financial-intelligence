...
| R06 | Backup unusable / untested restore | 2 | 3 | 6 | Neon backups + restore test before Type I. Runbook ready 2026-07-27 ([../runbooks/neon-restore-test.md](../runbooks/neon-restore-test.md)); **execution blocked** pending Matt Console PITR branch or `NEON_API_KEY` ([../evidence/neon-restore-test-2026-07-27.md](../evidence/neon-restore-test-2026-07-27.md)). | Medium until test done | Matt | Mitigate (open) |
...
| R16 | Unsigned / incomplete Customer DPA–MSA (privacy, retention, subprocessors) | 2 | 3 | 6 | **Single legal workstream** — counsel + Matt; track only in [../PROGRESS.md](../PROGRESS.md) + this row. P07/P08/P09 cross-reference here; do not treat as three separate policy gaps. | Medium until signed | Matt | Mitigate (open) |
