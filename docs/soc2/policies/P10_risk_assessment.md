...
| R16 | Unsigned / incomplete Customer DPA–MSA (privacy, retention, subprocessors) | 2 | 3 | 6 | **Single legal workstream** — counsel + Matt; track in [../PROGRESS.md](../PROGRESS.md) + this row. **Outline drafted 2026-07-28** ([../legal/DPA_MSA_OUTLINE.md](../legal/DPA_MSA_OUTLINE.md)) — awaiting counsel; **not closed**. P07/P08/P09 cross-reference here; do not treat as three separate policy gaps. | Medium until signed | Matt | Mitigate (open — outline in progress) |
