...
**Collection status:** **not complete** — Railway + Neon + Stripe + Anthropic Type II **received** (review pending); Vercel access **requested** (waiting); Resend still open. Readiness only — not SOC 2 certified.
...
6. **Resend** — **Next:** [resend.com/settings/documents](https://resend.com/settings/documents) → download **SOC 2** Type II (confirm period still current).
