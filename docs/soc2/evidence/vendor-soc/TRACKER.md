...
**Collection status:** **not complete** — Railway + Neon + Stripe Type II **received** (review pending); Vercel access **requested** (waiting); Anthropic/Resend still open. Readiness only — not SOC 2 certified.
...
5. **Anthropic** — **Next:** [trust.anthropic.com](https://trust.anthropic.com/) → sign in (Google IdP) → request/download SOC 2 Type II + ISO packs.
