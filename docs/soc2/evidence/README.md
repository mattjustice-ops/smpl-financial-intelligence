...
| [../DPA_COUNSEL_CHASE_PACK.md](../DPA_COUNSEL_CHASE_PACK.md) | DPA counsel chase pack — R16 ladder, chase email, cadence, what to file when redline returns; R16 still open |
