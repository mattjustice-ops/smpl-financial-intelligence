...
**Approved ≠ SOC 2 certified.** P01–P12 are approved company policy as of 2026-07-27; **P15** approved 2026-07-28; **IR tabletop complete** 2026-07-28; **access review 2026-Q3 signed** 2026-07-29. Open evidence items (vendor reports, DPA counsel, etc.) remain. SMPL is **not** SOC 2 certified until an independent CPA Type I report is in hand.
...
| P15 | AI / LLM Data Handling | Security; Confidentiality | Matt Justice | **Approved** (v1.1) | 2026-07-28 | [policies/P15_ai_llm_data_handling.md](./policies/P15_ai_llm_data_handling.md) |
...
| P15 | Matt Justice | 2026-07-28 | 1.1 |
...
| 2026-07-28 | **P15 v1.1 Approved** by Matt Justice (machine-primary grounding / fail-closed / freeze-ID binding; human review not primary) + IR Scenario B rewrite **Allowed** (chat). Approval ≠ SOC 2 certified. |
| 2026-07-28 | Normative controls docs added under [controls/](./controls/README.md); P15 §4.8 + Scenario B cite `_sources`, evidence-only Claude, freeze-ID, tie-out/second-pass gates; Part 6 adapted to periodic testing. |
