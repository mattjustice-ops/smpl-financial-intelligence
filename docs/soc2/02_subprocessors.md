...
**Status:** Named draft from known production stack. Regions and “report collected” columns need **[!]** Matt / eng confirmation. Do not publish externally until reviewed.
