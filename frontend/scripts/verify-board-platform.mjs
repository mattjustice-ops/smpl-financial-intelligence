...
const checks = [
  ...
  ["board HTML loads board-hydrate v26", boardHtml.includes("board-hydrate.js?v=26"), true],
  ["board-hydrate exports via Railway direct", fs.readFileSync(path.join(__dirname, "../public/shared/board-hydrate.js"), "utf8").includes("boardExportApiBase"), true],
