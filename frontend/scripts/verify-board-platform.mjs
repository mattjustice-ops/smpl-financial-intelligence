...
const checks = [
  ...
  ["board HTML loads board-hydrate v23", boardHtml.includes("board-hydrate.js?v=23"), true],
  ["board-hydrate uses direct Railway AI base", fs.readFileSync(path.join(__dirname, "../public/shared/board-hydrate.js"), "utf8").includes("boardAiApiBase"), true],
