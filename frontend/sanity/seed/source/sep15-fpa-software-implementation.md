...
**1. URL slug:** `fpa-software-implementation`

**2. SEO title (55 chars):** Why FP&A Implementations Shouldn't Take Months | SMPL.ai

**3. Meta description:** FP&A implementations run long because Finance ends up doing the work. What causes the delay, what Finance should own, and what to ask vendors before signing.

**4. H1:** Why FP&A Software Implementations Shouldn't Take Months
