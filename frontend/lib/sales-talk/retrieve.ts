...
const INTENT_RULES: IntentRule[] = [
  ...
  },
  {
    ...
    patterns: [
      /\bhow long (is|does|for) (implementation|onboarding|go[- ]live)\b/i,
      /\bimplementation (timeline|time|duration)\b/i,
      /\bonboarding timeline\b/i,
      /\bhow long to go live\b/i,
      /\b4[-–]?6 weeks\b/i,
      /\bfour to six weeks\b/i,
      /\bone week (implementation|onboarding|to value)?\b/i,
      /\b~?1 week\b/i,
    ],
    preferIds: ["implementation-security"],
    expandTokens: [
      "implementation",
      "timeline",
      "how long",
    ...
    penalizeIds: ["dna-pricing", "business-impact", "architecture-as-moat"],
  },
  {
    name: "time-to-value",
    patterns: [
    ...
    expandTokens: ["time-to-value", "value", "weeks", "one week", "hours"],
